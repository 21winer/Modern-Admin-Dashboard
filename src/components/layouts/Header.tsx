...
function Header({ onMenuClick, onThemeToggle, onSettingsClick, isDark, id = 0 }: { onMenuClick: () => void, onThemeToggle: () => void, onSettingsClick: () => void, isDark?: boolean, id?: number }) {
